...
quantity = {
    ...
    'unit': lambda unit: unit == 'bpm' or unit == 'm/s2' or unit=='m/s²' or unit == 'rad/s' or unit == 'Hz' or unit == 'seconds' or unit == 'none' or unit == 'Step' or unit=='degrees' ,  #TODO insert other possible values # Unit representation
